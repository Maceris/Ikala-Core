...
public class EventOrderListener implements Listener {
	...
	private void defaultOrder(SimpleEvent event) {
		Assert.assertTrue(this.called.get(Order.EARLIEST));
		Assert.assertTrue(this.called.get(Order.EARLY));
		Assert.assertFalse(this.called.get(Order.LATE));
		Assert.assertFalse(this.called.get(Order.LATEST));
		Assert.assertFalse(this.called.get(Order.MONITOR));
	...
	private void earliest(SimpleEvent event) {
		Assert.assertFalse(this.called.get(Order.EARLIEST));
		Assert.assertFalse(this.called.get(Order.EARLY));
		Assert.assertFalse(this.called.get(Order.DEFAULT));
		Assert.assertFalse(this.called.get(Order.LATE));
		Assert.assertFalse(this.called.get(Order.LATEST));
		Assert.assertFalse(this.called.get(Order.MONITOR));
	...
	private void late(SimpleEvent event) {
		Assert.assertTrue(this.called.get(Order.EARLIEST));
		Assert.assertTrue(this.called.get(Order.EARLY));
		Assert.assertTrue(this.called.get(Order.DEFAULT));
		Assert.assertFalse(this.called.get(Order.LATE));
		Assert.assertFalse(this.called.get(Order.LATEST));
		Assert.assertFalse(this.called.get(Order.MONITOR));
	...
	private void latest(SimpleEvent event) {
		...
		Assert.assertTrue(this.called.get(Order.EARLY));
		Assert.assertTrue(this.called.get(Order.DEFAULT));
		Assert.assertTrue(this.called.get(Order.LATE));
		Assert.assertFalse(this.called.get(Order.LATEST));
		Assert.assertFalse(this.called.get(Order.MONITOR));
