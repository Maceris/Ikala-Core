...
/**
 * Contains data about a particular package. This info can be loaded from code
 * or from a file.
 *
 * @author Ches Burks
 *
...
public class PackageInfo {
	...
	public PackageInfo(final InputStream stream)
		...
		// TODO list yaml tags
		this.loadMap(this.asMap(PackageInfo.YAML.get().load(stream)));
	}
	 ...
	 * package, such as "Graphics" or "AI", with version info appended.
	 *
	...
	/**
	 * Returns a list of permissions for this package
	 *
	 * @return this packages permissions
	 */
	...
	/**
	 * The version of the package. This value is a double that follows the
	...
	private void loadMap(Map<?, ?> map) throws InvalidDescriptionException {
		...
		this.depend = PackageInfo.makePackageNameList(map, "depend");
		this.softDepend = PackageInfo.makePackageNameList(map, "soft-depend");
		this.loadBefore = PackageInfo.makePackageNameList(map, "load-before");
