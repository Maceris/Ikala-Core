...
public interface IkalaScriptParserListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link IkalaScriptParser#expressionStatement}.
     *
     * @param ctx the parse tree
     */
    void enterExpressionStatement(IkalaScriptParser.ExpressionStatementContext ctx);
    ...
    /**
     * Enter a parse tree produced by {@link IkalaScriptParser#localVariableDeclarationStatement}.
     *
     * @param ctx the parse tree
     */
     ...
     * IkalaScriptParser#statementWithoutTrailingSubstatement}.
     *
     * @param ctx the parse tree
     */
    ...
    /**
     * Exit a parse tree produced by {@link IkalaScriptParser#expressionStatement}.
     *
     * @param ctx the parse tree
     */
    void exitExpressionStatement(IkalaScriptParser.ExpressionStatementContext ctx);
    ...
    /**
     * Exit a parse tree produced by {@link IkalaScriptParser#localVariableDeclarationStatement}.
     *
     * @param ctx the parse tree
     */
