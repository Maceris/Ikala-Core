...
public class IkalaScriptParser extends Parser {
	...
	public static final int RULE_literal = 0, RULE_primitiveType = 1,
		...
		RULE_methodInvocation = 48, RULE_methodInvocation_extension = 49,
		RULE_methodInvocation_LHS = 50, RULE_argumentList = 51,
		RULE_expression = 52, RULE_assignment = 53, RULE_leftHandSide = 54,
		RULE_assignmentOperator = 55, RULE_conditionalExpression = 56,
		RULE_conditionalOrExpression = 57, RULE_conditionalAndExpression = 58,
		RULE_equalityExpression = 59, RULE_relationalExpression = 60,
		RULE_additiveExpression = 61, RULE_multiplicativeExpression = 62,
		RULE_unaryExpression = 63, RULE_preIncrementExpression = 64,
		RULE_preDecrementExpression = 65, RULE_unaryExpressionNotPlusMinus = 66,
		RULE_postfixExpression = 67, RULE_postIncrementExpression = 68,
		RULE_postDecrementExpression = 69, RULE_castExpression = 70;
	...
	private static String[] makeRuleNames() {
		return new String[] {"literal", "primitiveType", "numericType",
			...
			"primary_LHS", "primary_LHS_access", "methodInvocation",
	...
	private ConditionalAndExpressionContext conditionalAndExpression(int _p)
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(526);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 42,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
	...
	private ConditionalOrExpressionContext conditionalOrExpression(int _p)
		...
		int _startState = 114;
		this.enterRecursionRule(_localctx, 114,
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(515);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 41,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
