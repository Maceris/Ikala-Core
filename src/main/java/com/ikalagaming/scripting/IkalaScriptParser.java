...
public class IkalaScriptParser extends Parser {
	...
	public static final int RULE_literal = 0, RULE_primitiveType = 1,
		...
		RULE_exitStatement = 45, RULE_primary = 46,
	...
	public static final String _serializedATN =
		"\u0004\u0001>\u0300\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001\u0002"
			...
			+ "-\u0001.\u0001.\u0005.\u01d7\b.\n.\f.\u01da\t.\u0001/\u0001/\u0001/\u0001"
			+ "/\u0001/\u0001/\u0001/\u0003/\u01e3\b/\u00010\u00010\u00010\u00030\u01e8"
			+ "\b0\u00011\u00011\u00031\u01ec\b1\u00012\u00012\u00012\u00012\u00012\u0001"
			+ "2\u00012\u00032\u01f5\b2\u00013\u00013\u00013\u00013\u00013\u00013\u0003"
			+ "3\u01fd\b3\u00014\u00014\u00014\u00014\u00015\u00015\u00015\u00016\u0001"
			+ "6\u00016\u00016\u00016\u00046\u020b\b6\u000b6\f6\u020c\u00016\u00016\u0001"
			+ "6\u00016\u00016\u00046\u0214\b6\u000b6\f6\u0215\u00036\u0218\b6\u0001"
			+ "7\u00017\u00017\u00017\u00017\u00047\u021f\b7\u000b7\f7\u0220\u00018\u0001"
			+ "8\u00018\u00018\u00018\u00048\u0228\b8\u000b8\f8\u0229\u00018\u00018\u0001"
			+ "8\u00018\u00018\u00048\u0231\b8\u000b8\f8\u0232\u00038\u0235\b8\u0001"
			...
			+ "G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001G\u0001"
			+ "G\u0001G\u0005G\u02ca\bG\nG\fG\u02cd\tG\u0001H\u0001H\u0001H\u0001H\u0001"
			+ "H\u0001H\u0001H\u0003H\u02d6\bH\u0001I\u0001I\u0001I\u0001J\u0001J\u0001"
			+ "J\u0001K\u0001K\u0001K\u0001K\u0003K\u02e2\bK\u0001L\u0001L\u0003L\u02e6"
			+ "\bL\u0001L\u0005L\u02e9\bL\nL\fL\u02ec\tL\u0001M\u0001M\u0001M\u0001N"
			+ "\u0001N\u0001N\u0001O\u0001O\u0001O\u0001O\u0001O\u0001O\u0001O\u0001"
			+ "O\u0001O\u0001O\u0003O\u02fe\bO\u0001O\u0000\u0006\u0084\u0086\u0088\u008a"
			+ "\u008c\u008eP\u0000\u0002\u0004\u0006\b\n\f\u000e\u0010\u0012\u0014\u0016"
	...
	private AdditiveExpressionContext additiveExpression(int _p)
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				_alt = this.getInterpreter().adaptivePredict(this._input, 66,
					this._ctx);
				while (_alt != 2
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							switch (this.getInterpreter()
								.adaptivePredict(this._input, 65, this._ctx)) {
								case 1: {
	...
	public final CastExpressionContext castExpression()
		...
		try {
			this.setState(765);
			this._errHandler.sync(this);
			switch (this.getInterpreter().adaptivePredict(this._input, 73,
				this._ctx)) {
				case 1:
					this.enterOuterAlt(_localctx, 1); {
					this.setState(755);
	...
	private EqualityExpressionContext equalityExpression(int _p)
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(664);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 62,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							this._errHandler.sync(this);
							switch (this.getInterpreter()
								.adaptivePredict(this._input, 61, this._ctx)) {
								case 1: {
	...
	public final ExitStatementContext exitStatement()
		...
		this.enterRule(_localctx, 90, IkalaScriptParser.RULE_exitStatement);
		try {
			this.enterOuterAlt(_localctx, 1);
			{
				this.setState(466);
	...
	private MultiplicativeExpressionContext multiplicativeExpression(int _p)
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(715);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 68,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							this._errHandler.sync(this);
							switch (this.getInterpreter()
								.adaptivePredict(this._input, 67, this._ctx)) {
								case 1: {
									_localctx =
	...
	public final PostfixExpressionContext postfixExpression()
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(746);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 72,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			this.enterOuterAlt(_localctx, 1);
			{
				...
				this.setState(472);
				this._errHandler.sync(this);
				_alt = this.getInterpreter().adaptivePredict(this._input, 37,
					this._ctx);
				while (_alt != 2
					&& _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
					if (_alt == 1) {
				...
				while (_alt != 2
					...
					if (_alt == 1) {
						...
						_prevctx = _localctx;
						{
							...
							this._errHandler.sync(this);
							switch (this.getInterpreter()
								.adaptivePredict(this._input, 63, this._ctx)) {
								case 1: {
