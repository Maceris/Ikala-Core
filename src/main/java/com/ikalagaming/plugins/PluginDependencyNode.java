...
/**
 * Used to create a dependency graph to resolve dependency cycles as part of loading plugins.
 *
 * @author Ches Burks
 */
@Getter
...
class PluginDependencyNode {
    ...
    /**
     * Add a child node to the list of plugins that this plugin depends on, records this node as its
     * parent.
     *
