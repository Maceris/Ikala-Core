...
public class PluginInfo {
	 ...
	 * @throws InvalidDescriptionException If the entry is not present, not a
	 *             list, or has invalid dependency names.
	 */
	...
	/**
	 * Load fields from a map, and throw an exception if the contents of the map
	 * are not valid.
	 *
